...
mdb.models['Model-1'].sketches['__profile__'].rectangle(point1=(0.0, 0.0),
                                                        point2=(20.0, 20.0))
p = mdb.models['Model-1'].Part(dimensionality=THREE_D, name='Composite', type=
DEFORMABLE_BODY)
p.BaseSolidExtrude(sketch=s, depth=dim)
...
for i in range(1, num_fibers + 1):
    ...
    part = mdb.models['Model-1'].Part(dimensionality=THREE_D, name='Composite', type=DEFORMABLE_BODY)
